...
@section('title', 'System Email Settings')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-1">System Email Settings</h1>
                    <p class="text-muted mb-0">Configure system-wide email settings for subscriptions and system notifications</p>
                </div>
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-outline-secondary" id="companyOverviewBtn">
                ...
                <div class="col-md-4">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 class="mb-0" id="companiesWithEmailCount">-</h4>
                                    <p class="mb-0">Companies with Email Config</p>
                                </div>
                                <div class="align-self-center">
                                    <i class="bi bi-envelope-gear fs-2"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('superadmin.email-settings.store') }}" method="POST" id="emailSettingsForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow-sm">
                            <div class="card-header bg-dark text-white">
                                <h5 class="mb-0"><i class="bi bi-gear me-2"></i>System SMTP Configuration</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card shadow-sm mt-4">
                            <div class="card-header bg-primary text-white">
                                <h5 class="mb-0"><i class="bi bi-envelope me-2"></i>System Email Configuration</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="company_logo_url" class="form-label">System Logo URL</label>
                                    <input type="url" class="form-control @error('company_logo_url') is-invalid @enderror" 
                                           ...
                                           placeholder="https://gobillo.com/logo.png">
                                    @error('company_logo_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Optional: URL to system logo for email templates</small>
                                </div>

                                <div class="mb-3">
                                    <label for="email_signature" class="form-label">System Email Signature</label>
                                    <textarea class="form-control @error('email_signature') is-invalid @enderror" 
                                              id="email_signature" name="email_signature" rows="4" 
                                              placeholder="Best regards,&#10;GoBillo Team&#10;support@gobillo.com">{{ old('email_signature', $emailSetting->email_signature) }}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="text-muted small mb-3">Select which system notifications to send automatically:</p>
                                
                                @php
                                    $enabledNotifications = old('enabled_notifications', $emailSetting->enabled_notifications ?: []);
                                @endphp

                                @foreach($superAdminCategories as $category => $notifications)
                                    <div class="mb-4">
                        ...
                        <div class="card shadow-sm mt-3">
                            <div class="card-header bg-info text-white">
                                <h6 class="mb-0"><i class="bi bi-info-circle me-2"></i>System Status</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow-sm mt-3">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-outline-primary btn-sm" id="sendTestNotificationBtn">
                                        <i class="bi bi-broadcast me-2"></i>Send Test to All Companies
                                    </button>
                                    <button type="button" class="btn btn-outline-info btn-sm" id="previewTemplateBtn">
                                        <i class="bi bi-eye me-2"></i>Preview Templates
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-2"></i>Save System Email Settings
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="testEmailModalLabel">Test System Email Configuration</h5>
            ...
            <div class="modal-body">
                <form id="testEmailForm">
                    ...
                    <div class="alert alert-info">
                        ...
                        This will send a test email using your current system configuration to verify it's working correctly.
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="usageStatsModal" tabindex="-1" aria-labelledby="usageStatsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="usageStatsModalLabel">System Email Usage Statistics</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row" id="usageStatsContent">
                    <div class="col-12 text-center">
                        ...
                        <p class="mt-2">Loading system usage statistics...</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="companyOverviewModal" tabindex="-1" aria-labelledby="companyOverviewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="companyOverviewModalLabel">Company Email Configuration Overview</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="companyOverviewContent">
                    <div class="text-center">
                        <div class="spinner-border text-primary" role="status">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        <p class="mt-2">Loading company overview...</p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Load companies with email config count on page load
    loadCompaniesWithEmailCount();
    ...
    sendTestEmailBtn.addEventListener('click', function() {
        ...
        fetch('{{ route("superadmin.email-settings.test") }}', {
            method: 'POST',
            headers: {
    ...
    const companyOverviewBtn = document.getElementById('companyOverviewBtn');
    const companyOverviewModal = new bootstrap.Modal(document.getElementById('companyOverviewModal'));
    const companyOverviewContent = document.getElementById('companyOverviewContent');

    companyOverviewBtn.addEventListener('click', function() {
        companyOverviewModal.show();
        loadCompanyOverview();
    });

    function loadCompaniesWithEmailCount() {
        fetch('{{ route("superadmin.email-settings.companies") }}')
        .then(response => response.json())
        .then(companies => {
            const count = companies.filter(company => company.has_email_config).length;
            document.getElementById('companiesWithEmailCount').textContent = count;
        })
        .catch(error => {
    ...
    function loadUsageStats() {
        fetch('{{ route("superadmin.email-settings.usage") }}')
        .then(response => response.json())
        .then(data => {
            usageStatsContent.innerHTML = `
                <div class="col-md-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body text-center">
                            <h3>${data.system_emails_sent_today}</h3>
                            <p class="mb-0">System Emails Today</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center">
                            <h3>${data.system_emails_sent_month}</h3>
                            <p class="mb-0">System Emails This Month</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center">
                            <h3>${data.company_emails_sent_today}</h3>
                            <p class="mb-0">Company Emails Today</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-warning text-dark">
                        <div class="card-body text-center">
                            <h3>${data.company_emails_sent_month}</h3>
                            <p class="mb-0">Company Emails This Month</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-body">
                            <h6>System Configuration Status</h6>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span>Active Company Configs:</span>
                                        <span class="badge bg-info">${data.active_company_configs}</span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        <span>Avg Emails per Company:</span>
                                        <span class="text-muted">${data.avg_emails_per_company}/month</span>
                                    </div>
                                </div>
                            </div>
    ...
    function loadCompanyOverview() {
        ...
        .then(response => response.json())
        .then(companies => {
            let tableRows = companies.map(company => `
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <span class="badge bg-${company.status === 'active' ? 'success' : 'secondary'} me-2">
                                ${company.status}
                            </span>
                            ${company.name}
                        </div>
                    ...
                    <td class="text-center">${company.emails_sent_month}</td>
                    <td class="text-center text-muted small">
                        ${company.last_tested || 'Never'}
                    </td>
                </tr>
            `).join('');

            companyOverviewContent.innerHTML = `
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th>Company</th>
                                <th>Email</th>
                                <th class="text-center">Has Config</th>
                                <th class="text-center">Verified</th>
                                <th class="text-center">Emails/Month</th>
                                <th class="text-center">Last Tested</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${tableRows}
        ...
        .catch(error => {
            companyOverviewContent.innerHTML = `
                <div class="alert alert-danger">
                    <i class="bi bi-exclamation-triangle me-2"></i>
                    Error loading company overview: ${error.message}
                </div>
            `;
        });
    }
    ...
    form.addEventListener('submit', function(e) {
        const requiredFields = ['name', 'smtp_host', 'smtp_port', 'smtp_username', 'smtp_encryption', 'from_email', 'from_name'];
        let isValid = true;
