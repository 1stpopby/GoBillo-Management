...
<p>This is a reminder that your GoBillo subscription is approaching its expiry date. Please take action to avoid service interruption.</p>
...
<div style="background-color: #f8f9fa; border-left: 4px solid #e74c3c; padding: 15px; margin: 20px 0;">
    ...
    <ul style="margin-bottom: 0; padding-left: 20px;">
        <li>Access to your GoBillo account will be suspended</li>
...
<p>To continue using GoBillo without interruption, please renew your subscription before the expiry date.</p>
...
<p>Thank you for choosing GoBillo!</p>
